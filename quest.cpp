...
- inline у функций
inline не обещает, что функция будет встроена в код, комплиятор сам решит, стоит ли это делать и сможет ли он это сделать.
...
инлайн функций с одинковым интерфейсом.
